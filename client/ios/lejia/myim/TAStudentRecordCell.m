...
@implementation TAStudentRecordCell
...
-(void)layoutSubviews{
    ...
    NSURL* headImgUrl=[NSURL URLWithString:_appointment.teacher.person.imageurl];
    [_headIcon sd_setImageWithURL:headImgUrl placeholderImage:[UIImage imageNamed:@"缺省头像"]];
    _headIcon.size=(CGSize){HEADIMG_SIZE,HEADIMG_SIZE};
    _headIcon.origin=(CGPoint){PADDING.left,PADDING.top};
    ...
    [_dateLabel fit];
    _dateLabel.origin=(CGPoint){_headIcon.right+HEADIMG_RIGHT_PADDING,_headIcon.top};
